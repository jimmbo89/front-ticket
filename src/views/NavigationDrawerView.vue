<template>
  <v-card flat class="busgo-drawer">
    ...
    <v-list nav density="comfortable" class="drawer-menu">
      ...
      <v-list-item
        v-if="hasPermission(['view_trips', 'view_trips_company', 'view_triptemplates_company', 'view_triptemplates'])"
...
export default {
  data: () => ({
    ...
    configuration: [
      { icon: "mdi-store-outline", title: "Sucursales", to: "branch", permission: "view_branches" },
      { icon: "mdi-account-group-outline", title: "Trabajadores", to: "worker", permission: "view_workers" },
      { icon: "mdi-bus-side", title: "Vehículos", to: "structure-vehicle", permission: "view_vehicles" },
      { icon: "mdi-seat-passenger", title: "Estructuras de Asientos", to: "structure", permission: "view_structures" },
      { icon: "mdi-map-marker-outline", title: "Ubicaciones", to: "location", permission: "view_locations" },
      { icon: "mdi-routes", title: "Rutas", to: "route", permission: "view_routes" },
      { icon: "mdi-devices", title: "Dispositivos", to: "device", permission: "view_devices" },
    ],

    tickets: [
      { title: "Tipos de Pasaje", icon: "mdi-ticket-percent-outline", to: "ticket-type", permission: "view_tickettype" },
    ...
    security: [
      ...
      { title: "Permisos", icon: "mdi-shield-check-outline", to: "permission", permission: "view_permissions" },
    ],
    ...
    reports: [
      ...
      { title: "Incidentes", icon: "mdi-alert-outline", to: "incident", permission: ["view_incidents", "view_incidents_company"] },
    ],
  }),
